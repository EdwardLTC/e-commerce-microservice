...
const (
	...
	OptionService_GetOptionValues_FullMethodName   = "/com.ecommerce.springboot.product.v1.OptionService/GetOptionValues"
)
...
type OptionServiceClient interface {
	...
	GetOptionValues(ctx context.Context, in *GetOptionValuesRequest, opts ...grpc.CallOption) (*GetOptionValuesResponse, error)
}
...
func (c *optionServiceClient) GetOptionValues(ctx context.Context, in *GetOptionValuesRequest, opts ...grpc.CallOption) (*GetOptionValuesResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetOptionValuesResponse)
	err := c.cc.Invoke(ctx, OptionService_GetOptionValues_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type OptionServiceServer interface {
	...
	GetOptionValues(context.Context, *GetOptionValuesRequest) (*GetOptionValuesResponse, error)
...
func (UnimplementedOptionServiceServer) GetOptionValues(context.Context, *GetOptionValuesRequest) (*GetOptionValuesResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetOptionValues not implemented")
}
...
func _OptionService_GetOptionValues_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetOptionValuesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(OptionServiceServer).GetOptionValues(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: OptionService_GetOptionValues_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OptionServiceServer).GetOptionValues(ctx, req.(*GetOptionValuesRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var OptionService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _OptionService_GetOptionValues_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "Product.proto",
...
const (
	...
	VariantService_GetVariantsByIds_FullMethodName = "/com.ecommerce.springboot.product.v1.VariantService/GetVariantsByIds"
)
...
type VariantServiceClient interface {
	...
	GetVariantsByIds(ctx context.Context, in *GetVariantByIdsRequest, opts ...grpc.CallOption) (*GetVariantsResponse, error)
}
...
func (c *variantServiceClient) GetVariantsByIds(ctx context.Context, in *GetVariantByIdsRequest, opts ...grpc.CallOption) (*GetVariantsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetVariantsResponse)
	err := c.cc.Invoke(ctx, VariantService_GetVariantsByIds_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type VariantServiceServer interface {
	...
	GetVariantsByIds(context.Context, *GetVariantByIdsRequest) (*GetVariantsResponse, error)
...
func (UnimplementedVariantServiceServer) GetVariantsByIds(context.Context, *GetVariantByIdsRequest) (*GetVariantsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetVariantsByIds not implemented")
}
...
func _VariantService_GetVariantsByIds_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetVariantByIdsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(VariantServiceServer).GetVariantsByIds(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: VariantService_GetVariantsByIds_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(VariantServiceServer).GetVariantsByIds(ctx, req.(*GetVariantByIdsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var VariantService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetVariantsByIds",
			Handler:    _VariantService_GetVariantsByIds_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "Product.proto",
