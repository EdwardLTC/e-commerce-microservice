...
const (
	...
	OrderService_GetOrders_FullMethodName   = "/com.ecommerce.golang.order.OrderService/GetOrders"
)
...
type OrderServiceClient interface {
	...
	GetOrders(ctx context.Context, in *ListOrdersRequest, opts ...grpc.CallOption) (*ListOrdersResponse, error)
}
...
func (c *orderServiceClient) GetOrders(ctx context.Context, in *ListOrdersRequest, opts ...grpc.CallOption) (*ListOrdersResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type OrderServiceServer interface {
	...
	GetOrders(context.Context, *ListOrdersRequest) (*ListOrdersResponse, error)
...
func (UnimplementedOrderServiceServer) GetOrders(context.Context, *ListOrdersRequest) (*ListOrdersResponse, error) {
...
func _OrderService_GetOrders_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServiceServer).GetOrders(ctx, req.(*ListOrdersRequest))
	}
	return interceptor(ctx, in, info, handler)
}
