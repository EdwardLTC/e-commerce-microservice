...
const (
	StockService_ReserveStock_FullMethodName = "/com.ecommerce.springboot.product.v1.StockService/ReserveStock"
	StockService_ReleaseStock_FullMethodName = "/com.ecommerce.springboot.product.v1.StockService/ReleaseStock"
)
...
func (c *stockServiceClient) ReleaseStock(ctx context.Context, in *ReleaseStockRequest, opts ...grpc.CallOption) (*wrapperspb.DoubleValue, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedStockServiceServer) ReleaseStock(context.Context, *ReleaseStockRequest) (*wrapperspb.DoubleValue, error) {
...
var StockService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "com.ecommerce.springboot.product.v1.StockService",
